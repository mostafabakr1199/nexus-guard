...
const nav = [
  ...
  { label: "Batch Screening", to: "/batch", icon: UploadCloud },
      ...
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-2.5 px-2 py-2">
          ...
          <div className="min-w-0 group-data-[collapsible=icon]:hidden">
            <div className="truncate text-sm font-semibold text-sidebar-foreground">Finaira</div>
            <div className="truncate text-[11px] text-sidebar-foreground/60">Screening Hub</div>
          </div>
        </div>
      </SidebarHeader>
      <SidebarContent>
